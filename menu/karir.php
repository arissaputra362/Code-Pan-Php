...
<body>
    ...
    <div id="mt" class="jumbotron jumbotron-karir text-center">
      <div class="container" data-aos="fade-up">
        <div class="content text-center">
          <h1>KARIR</h1>
          <p class="text-center">Kami mengundang individu terbaik dengan kemampuan yang beragam untuk bersama-sama menghasilkan karya yang akan menjadi sebuah capaian luar biasa di masa depan. </p>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <ul class="row">
          <li class="col-lg-3 col-sm-6" data-aos="fade-right">
            ...
            <div class="text">
              <h3>KERJA TIM</h3>
              <p>Bekerjasama adalah hal penting untuk meraih kesuksesan. Kami mendorong terciptanya keragaman pendapat dan saling percaya.</p>
            </div>
          </li>
          <li class="col-lg-3 col-sm-6" data-aos="fade-right" data-aos-delay="200">
            ...
            <div class="text">
              <h3>RESPEK</h3>
              <p>Kami memperlakukan semua karyawan, vendor, dan mitra dengan hormat. Kami berkembang dalam transparansi dan kejujuran.</p>
          </li>
          <li class="col-lg-3 col-sm-6" data-aos="fade-right" data-aos-delay="400">
            ...
            <div class="text">
              <h3>PASSION</h3>
              <p>Kami menjunjung tinggi keberhasilan karyawan, mitra, dan bahkan produk. Dengan passion yang tepat, karir Anda juga meningkat pesat.</p>
          </li>
    ...
    <div class="tabel-bergabung">
      <div class="container">
        ...
        <p class="text-under-table text-center" data-aos="fade-up">Kami selalu mencari orang-orang berbakat untuk bergabung dengan <a href="#">tim kami</a>. Follow kami di  <a href="#">LinkedIn.</a></p>
      </div>
