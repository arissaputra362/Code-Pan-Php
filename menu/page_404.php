          ...
          <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav mr-5">
                <li class="nav-item">
                  <a class="nav-link" href="../landingPage.php" onclick="moveMenuNav(this)">BERANDA <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <lottie-player src="https://assets7.lottiefiles.com/packages/lf20_afwjhfb2.json"  background="transparent"  speed="1"  style="width: 100%; height: auto;"  loop  autoplay></lottie-player>
                    </div>
                    <div class="col-lg-6 container-text">
                        ...
                        <p class="text-under-judul">Ini Bukan Halaman Yang Bos Cari ! Yuk Kembali Ke Jalan Yang Benar Yaaa…..</p>
                        <div class="btn-go row">
                            ...
                            <div class="col-lg-6 col-sm-12 visit-us">
                                <a href="" class="text-center hvr-icon-wobble-horizontal"><p>Visit About Us</p> <i class="fa fa-arrow-right hvr-icon"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
