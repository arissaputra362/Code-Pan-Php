...
<body>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-5">
              <li class="nav-item">
                <a class="nav-link active" href="#" onclick="moveMenuNav(this)">BERANDA <span class="sr-only">(current)</span></a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#" onclick="moveMenuNav(this)">TENTANG KAMI <span class="sr-only">(current)</span></a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="./menu/portofolio.php" onclick="moveMenuNav(this)">PORTOFOLIO <span class="sr-only">(current)</span></a>
              </li>
    ...
    <div id="mt" class="jumbotron d-flex justify-content-end">
      <div class="container" data-aos="fade-down">
        <div class="content col-12">
          ...
          <hr>
          <p class="col-lg-7 col-sm-12 p-0">Layanan jasa pembuatan software kami telah membantu banyak perusahaan untuk mempermudah dan meningkatkan kinerja IT mereka</p>
          <br>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-7 col-sm-12 p-keterangan" data-aos="fade-right">
            ...
            <div class="caption">
              <p>
                Kami tahu bahwa setiap bisnis Anda memerlukan teknologi yang handal dan mampu menekan pengeluaran. Bagi kami, pengalaman pengguna adalah kunci utama untuk menghadirkan sistem yang paling handal
              </p>
            </div>
            ...
            <ul>
              ...
              <li>
                ...
                <div class="text">
                  ...
                  <p>Sering kali pengguna merasa kesulitan dalam melacak data-data mereka karena lemahnya pengolahan sistem IT.</p>
              </li>
            </ul>
          </div>
        </div>
    ...
    <div class="portofolio">
      <div class="container text-center">
        <div class="container-judul">
          ...
          <p class="keterangan-judul">Dengan pengalaman yang cukup, tenaga ahli kami mampu merampingkan proses dan memberikan solusi handal untuk mendukung produktivitas bisnis Anda</p>
        </div>
          ...
          <div class="col-lg-6 col-md-6 batas-card">
            <div class="card h-100">
              ...
              <div class="card-body text-left">
                ...
                <p class="card-text">Twins Robo Apps adalah suatu aplikasi media pembelajaran programming robot line maze berbasis mobile untuk membantu siswa SD, SMP, SMA yang ingin belajar programming secara basic dan dikemas dalam bentuk games secara multiplayer dan langsung bisa di implementasikan/di upoad ke dalam robot scara real.</p>
                <a href="#" class="btn btn-primary hvr-bounce-to-top">SELENGKAPNYA</a>
              </div>
            </div>
          </div>
    ...
    <div class="alasan-bermitra">
      <div class="container">
        <div class="container-judul row" data-aos="fade-up">
          ...
          <div class="col-md-6 col-sm-12">
            <p>Inilah 6 alasan mengapa Anda harus memilih kami untuk merampingkan proses, membangun sistem, serta memberi saran kepada Anda yang dapat meningkatkan produktivitas perusahaan</p>
          </div>
        </div>
        ...
        <ul class="items row">
          <li class="col-md-4 col-sm-6 mx-0 item" data-aos="zoom-in-up" data-aos-delay="200">
            ...
            <div class="text">
              <h3>Respon Cepat</h3>
              <p>Dengan dukungan nomor pusat keluhan via Whatsapp di nomer 081252200899 dan nomor telepon (031) 8437588 kami hadirkan layanan cepat atas setiap keluhan yang dialami mitra.</p>
            </div>
          </li>
          <li class="col-md-4 col-sm-6 mx-0 item" data-aos="zoom-in-up" data-aos-delay="200">
            <div class="text-img">
          ...
          <li class="col-md-4 col-sm-6 mx-0 item" data-aos="zoom-in-up" data-aos-delay="300">
            ...
            <div class="text">
              ...
              <p>Dengan didukung tenaga ahli yang
                ...
                sebuah layanan yang berkualitas dalam berbagai platform teknologi baik mobile, desktop, web, maupun hardware.</p>
            </div>
          </li>
          <li class="col-md-4 col-sm-6 mx-0 item" data-aos="zoom-in-up" data-aos-delay="300">
            <div class="text-img">
        ...
        <div class="end-text" data-aos="fade-up">
          <p>Sudah saatnya bisnis Anda terbang lebih tinggi. <a href="" class="hvr-underline-from-left">Telusuri perusahaan kami.</a></p>
        </div>
      </div>
    </div>
    ...
    <div class="page-blog">
      <div class="container">
        ...
        <p class="text-center text-under-judul">Telusuri Blog Codepan Studio untuk gagasan yang berharga dan pemikiran inovatif tentang trend IT masa kini</p>
          ...
          <div class="col-lg-4 col-md-6 margin-blog" data-aos="zoom-out-down">
            <div class="card hvr-underline-reveal">
              ...
              <div class="card-body">
                ...
                <p class="card-text">Teknologi firewall adalah salah satu dari sekian banyak sistem keamanan yang dapat di terapkan pada jaringan private inte…</p>
              </div>
            </div>
          </div>
        ...
        <p class="text-center text-under-container" data-aos="fade-up">Wawasan baru membantu Anda melakukan pekerjaan dengan lebih baik dan efisien. <a href="" class="hvr-underline-from-left">Lihat semua artikel.</a></p>
      </div>
